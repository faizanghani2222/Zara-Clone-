...
export const ProductsDetail=()=>{
  ...
  <ButtonGroup className='navbtnbox' gap='2' ml={["2em",0,0]} pt='0.7rem' mr={[0,null,'1rem']}>
    <Button className='navbarbtn search' fontWeight="500" borderBottom='1px'  borderColor='Black' color='Black' outline='none' p='0px' justifyContent="flex-start"  variant='ghost'>Search</Button>
    <Button className='navbarbtn loginbtn'  fontWeight="400" color="#000000" variant='link'>Login</Button>
    <Button className='navbarbtn' fontWeight="400" color="#000000" variant='link'>Help</Button>
